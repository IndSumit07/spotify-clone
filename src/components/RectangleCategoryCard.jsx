...
const RectangleCategoryCard = ({props}) => {
  return (
    <Link to={`/album/${props.id}`} state={{title:props.title, coverImage:props.coverImage, singer:props.singer, color:props.glowColor}} className='bg-white w-[160px] h-[55px] rounded-lg border-black border-[2px] border-r-[4px] border-b-[4px] flex justify-center items-center overflow-hidden'>
